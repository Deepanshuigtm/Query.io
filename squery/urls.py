...
urlpatterns = [
    ...
    path("task2",views.test, name = "test"),
    ...
    path("hod-dashboard/", views.hodDashboard, name = "hod_dash"),
    ...
    path('<int:post_id>/resolved_post/', views.resolved_post, name='resolved_post'),
